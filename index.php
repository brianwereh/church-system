...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  <option value="Female">Female</option>
								...
								<p> 
                                    ...
                                    <input id="usernamesignup" type="date" name="birthday" min="2000-08-06" />
                                </p>
								<p> 
